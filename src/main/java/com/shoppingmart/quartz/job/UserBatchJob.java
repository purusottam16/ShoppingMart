package com.shoppingmart.quartz.job;
...
public class UserBatchJob {
    ...
    private String directoryPath = "C:/TeamForge/ShoppingMart/trunk/src/main/resources/csv";
    ...
    public void performJob() {
        System.out.println("Starting UserBatchJob Job");
         
        try{
         
            if(contentDirectory== null || !contentDirectory.isDirectory()){
                System.err.println("Input directory doesn't exist. Job UserBatchJob terminated");
            }
            ...
            for(File file : contentDirectory.listFiles()){
                if(file.isFile()){
                    ...
                    System.out.println("UserBatchJob Job completetion details : "+result.toString());
                }
            }
            if(!fileFound){
            ...
            System.out.println("UserBatchJob Job halted with following excpetion :" + ex);
        }
