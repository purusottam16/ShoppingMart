                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="${pageContext.servletContext.contextPath}/checkout/customer-order.htm" class="btn btn-template-main btn-sm">View</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th># 1735</th>
                        ...
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active">
                                        <a href="${pageContext.servletContext.contextPath}/checkout/customer-orders.htm"><i class="fa fa-list"></i> My orders</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.servletContext.contextPath}/checkout/customer-wishlist.htm"><i class="fa fa-heart"></i> My wishlist</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.servletContext.contextPath}/checkout/customer-account.htm"><i class="fa fa-user"></i> My account</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.servletContext.contextPath}/logout"><i class="fa fa-sign-out"></i> Logout</a>
                                    </li>
                                </ul>
                            </div>
