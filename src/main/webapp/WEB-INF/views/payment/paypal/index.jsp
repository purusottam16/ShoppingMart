   ...
   <div class="span6">
      <h4>README</h4>
          <p>
                  ...
                  <br>
                  4) The sample code uses default sandbox Seller credentials which are set in config/config.properties. You can create your own credentials by creating PayPal Seller and Buyer accounts on Sandbox  <i><a href="https://developer.paypal.com/webapps/developer/applications/accounts/create" target="_blank">here</a></i>.
                  <br>
         ...
         1) Copy the files and folders under 'PaypalCredit' package to the same location where you have your shopping cart page.
               ...
               <br><br>
   <pre><code>&lt;form action="ExpressCheckout" method="POST"&gt;
