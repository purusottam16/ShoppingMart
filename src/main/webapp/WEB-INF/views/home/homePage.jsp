...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="icon" type="image/png" href="${pageContext.servletContext.contextPath}/icons/favicon.ico">

        <!--Google Font link-->
        <link href="https://fonts.googleapis.com/css?family=Raleway:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">


        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/slick/slick.css"> 
        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/slick/slick-theme.css">
        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/animate.css">
        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/iconfont.css">
        ...
        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/bootsnav.css">

        <!-- xsslider slider css -->


        <!--<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/xsslider.css">-->




        <!--For Plugins external css-->
        <!--<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/plugins.css" />-->

        <!--Theme custom css -->
        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/style.css">
        <!--<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/colors/maron.css">-->

        <!--Theme Responsive css-->
        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/responsive.css" />

        <script src="${pageContext.servletContext.contextPath}/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
                ...
                <div class="container"> 
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#brand">
                            <img src="${pageContext.servletContext.contextPath}/images/logo.png" class="logo" alt="">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                                ...
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        ...
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.servletContext.contextPath}/images/work-img1.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="${pageContext.servletContext.contextPath}/images/work-img2.jpg" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.servletContext.contextPath}/images/work-img2.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="${pageContext.servletContext.contextPath}/images/work-img3.jpg" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.servletContext.contextPath}/images/work-img3.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="${pageContext.servletContext.contextPath}/images/work-img4.jpg" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.servletContext.contextPath}/images/work-img4.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="${pageContext.servletContext.contextPath}/images/work-img1.jpg" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.servletContext.contextPath}/images/work-img1.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                ...
                <div class="main_footer fix bg-mega text-center p-top-40 p-bottom-30 m-top-80">
                    <div class="col-md-12">
                        <p class="wow fadeInRight" data-wow-duration="1s">
                            ...
                            by 
                            <a target="_blank" href="">ShoppingMart</a> 
        ...
        <script src="${pageContext.servletContext.contextPath}/js/vendor/jquery-1.11.2.min.js"></script>
        <script src="${pageContext.servletContext.contextPath}/js/vendor/bootstrap.min.js"></script>
        ...
        <script src="${pageContext.servletContext.contextPath}/css/slick/slick.js"></script>
        <script src="${pageContext.servletContext.contextPath}/css/slick/slick.min.js"></script>
        <script src="${pageContext.servletContext.contextPath}/js/jquery.collapse.js"></script>
        <script src="${pageContext.servletContext.contextPath}/js/bootsnav.js"></script>
