...
<body>
	<link
		...
		rel="stylesheet">
	<link rel="stylesheet"
		href="${pageContext.servletContext.contextPath}/css/transview.css" />
<body>
			...
			<%-- <sec:authorize access="hasRole('ADMIN') or hasRole('MANAGER')">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="/edit-user-${user.ssoId}"><span
									...
									<form class="form" role="form" method="post" action="${loginUrl}"
										...
										<div class="form-group">
											<label class="sr-only" for="exampleInputEmail2">Email
												...
												id="username" name="email" placeholder="Email address" required>
										</div>
										<div class="form-group">
