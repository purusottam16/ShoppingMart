            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 clearfix" id="checkout">
                        ...
                        <div class="box">
                        <form:form modelAttribute="userCheckoutDetails" action="${pageContext.servletContext.contextPath}/checkout/review.htm">
                           <%--  <form method="post" action="shop-checkout4.html"> --%>
                               <div class="wthreecartaits wthreecartaits2 cart cart box_1">
                                <ul class="nav nav-pills nav-justified">
                                    ...
                                    <li><a href="${pageContext.servletContext.contextPath}/checkout/delivery-method.htm"><i class="fa fa-truck"></i><br>Delivery Method</a>
                                    </li>
                                    <li><a href="${pageContext.servletContext.contextPath}/checkout/payment-method.htm"><i class="fa fa-money"></i><br>Payment Method</a>
                                    </li>
                                ...
                                <div class="box-footer">
                                    <div class="pull-left">
                                        <a href="${pageContext.servletContext.contextPath}/checkout/payment-method.htm" class="btn btn-default hvr-outline-out"><i class="fa fa-chevron-left"></i>BACK TO PAYMENT METHOD</a>
                                    </div>
                                    <div class="pull-right">
                                        <button type="submit" class="btn btn-template-main hvr-outline-out">PLACE AN ORDER<i class="fa fa-chevron-right"></i>
                                        </button>
                                    </div>
                                </div>
                            <%-- </form> --%>
