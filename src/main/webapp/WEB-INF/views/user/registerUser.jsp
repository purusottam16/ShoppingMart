	...
	<div class="container">
		...
		<div class="generic-container">
			...
			<form:form method="POST" modelAttribute="user"
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-sm-3 control-lable" for="userProfiles">Roles</label>
						<div class="col-md-4">
							<form:select path="userProfiles" items="${roles}" multiple="true"
								itemValue="id" itemLabel="type" class="form-control input-sm-3" />
							<div class="has-error">
				...
				<c:if test="${edit}">
					<span class="well pull-left"> <a
						href="<c:url value='/add-document-${user.id}' />">Click here
							to upload/manage your documents</a>
					</span>
				</c:if>
			</form:form>
		</div>
